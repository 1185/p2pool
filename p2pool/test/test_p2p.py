    ...
    def test_sharereq(self):
        class MyNode(p2p.Node):
            def __init__(self, df):
                p2p.Node.__init__(self, lambda: None, 29343, networks.nets['starwels'], {}, set([('127.0.0.1', 9343)]), 0, 0, 0, 0)
        ...
        class MyNode(p2p.Node):
            ...
            def got_conn(self, conn):
                ...
                for i in xrange(3):
                    ...
                    new_mining_txs[starwels_data.hash256(starwels_data.tx_type.pack(huge_tx))] = huge_tx
