...
def main(args, net, datadir_path, merged_urls, worker_endpoint):
    try:
        ...
        web_root = web.get_web_root(wb, datadir_path, starwelsd_getinfo_var)
                ...
                try:
                    ...
                    if height > 2:
                        ...
                        this_str += '\n Shares: %i (%i orphan, %i dead) Stale rate: %s Efficiency: %s Current payout: %.4f %s' % (
                            ...
                            node.get_current_txouts().get(starwels_data.pubkey_hash_to_script2(my_pubkey_hash), 0)*1e-8, net.PARENT.SYMBOL,
                        )
...
def run():
    ...
    parser.add_argument('-a', '--address',
        help='generate payouts to this address (default: <address requested from starwelsd>)',
