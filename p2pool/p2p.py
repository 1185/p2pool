...
class Protocol(p2protocol.Protocol):
    ...
    def sendShares(self, shares, tracker, known_txs, include_txs_with=[]):
        ...
        for share in shares:
            ...
            new_tx_size = sum(100 + starwels_data.tx_type.packed_size(known_txs[x]) for x in hashes_to_send)
            all_tx_size = sum(100 + starwels_data.tx_type.packed_size(known_txs[x]) for x in all_hashes)
